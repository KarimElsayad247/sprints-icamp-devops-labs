...
cd myteam # > bash: cd: myteam/: Permission denied
...
# Change your default permissions to be no permission 
# to everyone then create a directory and a file to verify.
umask 0777
touch f1
mkdir d1
cd d1 # bash: cd: d1: Permission denied
cp f1 f2 # cp: cannot open 'f1' for reading: Permission denied
...
touch f1
chmod 444 f1
echo hello > f1 # bash: f1: Permission denied
rm f1 # rm: remove write-protected regular empty file 'f1'? y # deleted
